...
export const TRIVIA_QUESTIONS: TriviaQuestion[] = [
  ...
  { question: "Who kills Bellatrix Lestrange?", options: ["Harry Potter", "Ginny Weasley", "Hermione Granger", "Molly Weasley"], correctAnswer: 3 },
  ...
  { question: "What spell cuts off George's ear?", options: ["Sectumsempra", "Avada Kedavra", "Diffindo", "Confringo"], correctAnswer: 0 },
  { question: "What spell unlocks the One-Eyed Witch hump?", options: ["Dissendium", "Alohomora", "Aparecium", "Open Sesame"], correctAnswer: 0 },
  { question: "What spell produces a flock of birds?", options: ["Avis", "Orchideous", "Serpensortia", "Oppugno"], correctAnswer: 0 },
  { question: "What spell produces flowers?", options: ["Orchideous", "Avis", "Herbivicus", "Floresco"], correctAnswer: 0 },
  { question: "What spell makes a voice loud?", options: ["Sonorus", "Quietus", "Muffliato", "Amplificatum"], correctAnswer: 0 },
  { question: "What spell makes the Dark Mark appear?", options: ["Morsmordre", "Periculum", "Verdimillious", "Flagrate"], correctAnswer: 0 },
  ...
  { question: "What is the name of the map showing Hogwarts?", options: ["Marauder's Map", "Hogwarts Map", "Map of Secrets", "Traveler's Map"], correctAnswer: 0 },
  { question: "What does the Deluminator do?", options: ["Steals light", "Creates light", "Explodes", "Heals"], correctAnswer: 0 },
  { question: "What is the Hand of Glory?", options: ["A candle holder", "A weapon", "A door knocker", "A glove"], correctAnswer: 0 },
  { question: "Who bought the Hand of Glory?", options: ["Draco Malfoy", "Lucius Malfoy", "Harry Potter", "Voldemort"], correctAnswer: 0 },
  { question: "What necklace is cursed in Borgin and Burkes?", options: ["Opal Necklace", "Pearl Necklace", "Diamond Necklace", "Ruby Necklace"], correctAnswer: 0 },
  { question: "Who touched the cursed necklace?", options: ["Katie Bell", "Leanne", "Hermione", "Harry"], correctAnswer: 0 },
  { question: "What is the password to Dumbledore's office in Book 2?", options: ["Sherbet Lemon", "Cockroach Cluster", "Acid Pops", "Fizzing Whizzbee"], correctAnswer: 0 },
  { question: "What is the password to Dumbledore's office in Book 4?", options: ["Cockroach Cluster", "Sherbet Lemon", "Acid Pops", "Lemon Drop"], correctAnswer: 0 },
  { question: "What is the password to Dumbledore's office in Book 6?", options: ["Acid Pops", "Toffee Eclair", "Baubles", "Festive"], correctAnswer: 0 },
  ...
  { question: "What is the name of Hagrid's dog?", options: ["Fang", "Fluffy", "Norbert", "Aragog"], correctAnswer: 0 },
  { question: "What is the name of the three-headed dog?", options: ["Fluffy", "Fang", "Norbert", "Ripper"], correctAnswer: 0 },
  ...
  { question: "What creature did Lupin bring to his first class?", options: ["Boggart", "Grindylow", "Hinkypunk", "Kappa"], correctAnswer: 0 },
  { question: "What is a Grindylow?", options: ["Water demon", "Tree spirit", "Rock monster", "Fire lizard"], correctAnswer: 0 },
  { question: "What is a Kappa?", options: ["Japanese water demon", "Irish ghost", "Scottish kelpie", "Welsh dragon"], correctAnswer: 0 },
  { question: "What is a Red Cap?", options: ["Goblin-like creature", "Dwarf", "Elf", "Troll"], correctAnswer: 0 },
  { question: "What is a Hinkypunk?", options: ["A one-legged creature", "A ghost", "A poltergeist", "A spirit"], correctAnswer: 0 },
  ...
  { question: "Where is the entrance to St Mungo's?", options: ["Purge and Dowse Ltd", "Gladrags Wizardwear", "Gambol and Japes", "Borgin and Burkes"], correctAnswer: 0 },
  { question: "What floor is the Room of Requirement on?", options: ["7th", "1st", "Ground", "Dungeon"], correctAnswer: 0 },
  { question: "Where is the Prefects' Bathroom?", options: ["5th Floor", "3rd Floor", "Dungeons", "7th Floor"], correctAnswer: 0 },
  { question: "Where is the Trophy Room?", options: ["3rd Floor", "1st Floor", "Ground Floor", "5th Floor"], correctAnswer: 0 },
  { question: "Where does the passage behind the Gregory the Smarmy statue lead?", options: ["Outside Hogwarts", "The Kitchens", "The Room of Requirement", "Dumbledore's Office"], correctAnswer: 0 },
  { question: "Where does the passage under the One-Eyed Witch lead?", options: ["Honeydukes Cellar", "The Shrieking Shack", "The Hog's Head", "Zonko's"], correctAnswer: 0 },
  { question: "Where does the passage under the Whomping Willow lead?", options: ["The Shrieking Shack", "Honeydukes", "The Hog's Head", "The Forest"], correctAnswer: 0 },
  { question: "Where does the Vanishing Cabinet in the Room of Requirement lead?", options: ["Borgin and Burkes", "Malfoy Manor", "The Ministry", "Diagon Alley"], correctAnswer: 0 },
  ...
  { question: "Who destroyed the Cup Horcrux?", options: ["Hermione Granger", "Harry Potter", "Ron Weasley", "Neville Longbottom"], correctAnswer: 0 },
  { question: "Who destroyed the Locket Horcrux?", options: ["Ron Weasley", "Harry Potter", "Hermione Granger", "Neville Longbottom"], correctAnswer: 0 },
  { question: "Who destroyed the Ring Horcrux?", options: ["Dumbledore", "Harry", "Snape", "Voldemort"], correctAnswer: 0 },
  { question: "Who destroyed the Diadem Horcrux?", options: ["Crabbe (Fiendfyre)", "Harry", "Ron", "Hermione"], correctAnswer: 0 },
  { question: "Who destroyed the Nagini Horcrux?", options: ["Neville Longbottom", "Harry", "Ron", "Hermione"], correctAnswer: 0 },
  { question: "Who destroyed the Harry Horcrux?", options: ["Voldemort", "Harry", "Dumbledore", "Snape"], correctAnswer: 0 },
  { question: "Who founded the Slug Club?", options: ["Horace Slughorn", "Severus Snape", "Albus Dumbledore", "Tom Riddle"], correctAnswer: 0 },
  ...
  { question: "Who wrote 'The Life and Lies of Albus Dumbledore'?", options: ["Rita Skeeter", "Elphias Doge", "Bathilda Bagshot", "Luna Lovegood"], correctAnswer: 0 },
  ...
  { question: "Who is the Bloody Baron?", options: ["Slytherin Ghost", "Gryffindor Ghost", "Ravenclaw Ghost", "Hufflepuff Ghost"], correctAnswer: 0 },
  { question: "Who is the Grey Lady?", options: ["Helena Ravenclaw", "Rowena Ravenclaw", "Moaning Myrtle", "The Fat Lady"], correctAnswer: 0 },
  { question: "Who is the Fat Friar?", options: ["Hufflepuff Ghost", "Gryffindor Ghost", "Slytherin Ghost", "Ravenclaw Ghost"], correctAnswer: 0 },
  { question: "Who is Nearly Headless Nick?", options: ["Sir Nicholas de Mimsy-Porpington", "Sir Patrick Delaney-Podmore", "Sir Cadogan", "The Bloody Baron"], correctAnswer: 0 },
  { question: "Who founded Hogwarts?", options: ["Godric, Helga, Rowena, Salazar", "Albus, Aberforth, Ariana", "Harry, Ron, Hermione", "Merlin, Morgana, Arthur"], correctAnswer: 0 },
  ...
  { question: "Who won the House Cup in Harry's first year?", options: ["Gryffindor", "Slytherin", "Ravenclaw", "Hufflepuff"], correctAnswer: 0 },
  { question: "Who won the House Cup in Harry's second year?", options: ["Gryffindor", "Slytherin", "Ravenclaw", "Hufflepuff"], correctAnswer: 0 },
  { question: "Who won the House Cup in Harry's third year?", options: ["Gryffindor", "Slytherin", "Ravenclaw", "Hufflepuff"], correctAnswer: 0 },
  { question: "Who won the Quidditch Cup in Harry's third year?", options: ["Gryffindor", "Slytherin", "Ravenclaw", "Hufflepuff"], correctAnswer: 0 },
  
  // MISC
  { question: "What organization did Hermione start?", options: ["S.P.E.W.", "D.A.", "The Order", "Slug Club"], correctAnswer: 0 },
  ...
  { question: "What is Hermione's Patronus?", options: ["Otter", "Stag", "Doe", "Cat"], correctAnswer: 0 },
  ...
  { question: "What is Snape's Patronus?", options: ["Doe", "Stag", "Lily", "Snake"], correctAnswer: 0 },
  ...
  { question: "What is Arthur Weasley's Patronus?", options: ["Weasel", "Badger", "Bear", "Horse"], correctAnswer: 0 },
  { question: "What is Kingsley Shacklebolt's Patronus?", options: ["Lynx", "Lion", "Leopard", "Tiger"], correctAnswer: 0 },
  { question: "What is Cho Chang's Patronus?", options: ["Swan", "Rabbit", "Horse", "Otter"], correctAnswer: 0 },
  { question: "What is Seamus Finnigan's Patronus?", options: ["Fox", "Badger", "Rabbit", "Dog"], correctAnswer: 0 },
  { question: "Who said 'After all this time? Always.'?", options: ["Snape", "Dumbledore", "Harry", "Lily"], correctAnswer: 0 },
  { question: "Who said 'I solemnly swear that I am up to no good'?", options: ["The Marauders", "Fred & George", "Harry", "Ron"], correctAnswer: 0 },
  { question: "Who said 'Not my daughter, you bitch!'?", options: ["Molly Weasley", "Lily Potter", "McGonagall", "Ginny Weasley"], correctAnswer: 0 },
  { question: "Who said 'Fear of a name increases fear of the thing itself'?", options: ["Dumbledore (Book) / Hermione (Movie)", "Harry", "Snape", "McGonagall"], correctAnswer: 0 },
  { question: "What flavor bean did Dumbledore eat in the hospital wing?", options: ["Earwax", "Vomit", "Toffee", "Spinach"], correctAnswer: 0 },
  { question: "What flavor bean did Dumbledore eat at the end of Book 1?", options: ["Earwax", "Vomit", "Toffee", "Spinach"], correctAnswer: 0 },
  { question: "What did Hagrid give Harry for his 11th birthday?", options: ["A Cake and an Owl", "A Wand", "A Toad", "Money"], correctAnswer: 0 },
  { question: "What day is Harry's birthday?", options: ["July 31", "July 30", "August 1", "June 31"], correctAnswer: 0 },
  { question: "What day is Voldemort's birthday?", options: ["December 31", "October 31", "July 31", "January 1"], correctAnswer: 0 },
  { question: "What day is Fred and George's birthday?", options: ["April 1", "July 31", "October 31", "December 25"], correctAnswer: 0 },
  { question: "What house was Tonks in?", options: ["Hufflepuff", "Gryffindor", "Ravenclaw", "Slytherin"], correctAnswer: 0 },
  { question: "What house was Moaning Myrtle in?", options: ["Ravenclaw", "Gryffindor", "Hufflepuff", "Slytherin"], correctAnswer: 0 },
  { question: "What house was Lockhart in?", options: ["Ravenclaw", "Gryffindor", "Hufflepuff", "Slytherin"], correctAnswer: 0 },
  { question: "What house was Hagrid in?", options: ["Gryffindor", "Hufflepuff", "Ravenclaw", "Slytherin"], correctAnswer: 0 },
  { question: "What house was Merlin in?", options: ["Slytherin", "Gryffindor", "Ravenclaw", "Hufflepuff"], correctAnswer: 0 },
  { question: "What house was Newt Scamander in?", options: ["Hufflepuff", "Gryffindor", "Ravenclaw", "Slytherin"], correctAnswer: 0 },
  ...
  { question: "Who referee'd the Quidditch World Cup Final?", options: ["Hassan Mostafa", "Ludo Bagman", "Madam Hooch", "Barty Crouch"], correctAnswer: 0 },
  ...
  { question: "What position does Harry play?", options: ["Seeker", "Chaser", "Keeper", "Beater"], correctAnswer: 0 },
  { question: "What position does Ron play?", options: ["Keeper", "Chaser", "Seeker", "Beater"], correctAnswer: 0 },
  { question: "What position did James Potter play (Movie)?", options: ["Seeker", "Chaser", "Keeper", "Beater"], correctAnswer: 0 },
  { question: "What position did James Potter play (Book)?", options: ["Chaser", "Seeker", "Keeper", "Beater"], correctAnswer: 0 },
  ...
  { question: "How many points for a goal in Quidditch?", options: ["10", "20", "50", "100"], correctAnswer: 0 },
  { question: "What ball tries to knock players off brooms?", options: ["Bludger", "Quaffle", "Snitch", "Remembrall"], correctAnswer: 0 },
  { question: "What ball is used to score goals?", options: ["Quaffle", "Bludger", "Snitch", "Remembrall"], correctAnswer: 0 },
  { question: "How many players on a Quidditch team?", options: ["7", "6", "5", "8"], correctAnswer: 0 },
  { question: "What are the names of the balls in Quidditch?", options: ["Quaffle, Bludger, Snitch", "Quaffle, Dodger, Snitch", "Quaffle, Bludger, Stitch", "Waffle, Bludger, Snitch"], correctAnswer: 0 },
  { question: "Who is the conductor of the Knight Bus?", options: ["Stan Shunpike", "Ernie Prang", "Cornelius Fudge", "Tom"], correctAnswer: 0 },
  { question: "Who is the driver of the Knight Bus?", options: ["Ernie Prang", "Stan Shunpike", "Tom", "Leaky"], correctAnswer: 0 },
  { question: "What colour is the Knight Bus?", options: ["Purple", "Red", "Blue", "Green"], correctAnswer: 0 },
  { question: "How much does a ticket on the Knight Bus cost (with hot chocolate)?", options: ["14 Sickles", "11 Sickles", "13 Sickles", "15 Sickles"], correctAnswer: 0 },
  { question: "What does the Knight Bus do if it's about to crash?", options: ["Jumps out of the way", "Shrinks", "Stops instantly", "Goes invisible"], correctAnswer: 0 },
  { question: "Who teaches Astronomy?", options: ["Professor Sinistra", "Professor Vector", "Professor Burbage", "Professor Grubbly-Plank"], correctAnswer: 0 },
  { question: "Who teaches Arithmancy?", options: ["Professor Vector", "Professor Sinistra", "Professor Burbage", "Professor Trelawney"], correctAnswer: 0 },
  { question: "Who teaches Flying?", options: ["Madam Hooch", "Professor Grubbly-Plank", "Charlie Weasley", "Oliver Wood"], correctAnswer: 0 },
  { question: "Who is the caretaker's cat?", options: ["Mrs. Norris", "Crookshanks", "Fang", "Ripper"], correctAnswer: 0 },
  { question: "Who is Hermione's cat?", options: ["Crookshanks", "Mrs. Norris", "Fang", "Ripper"], correctAnswer: 0 },
  { question: "Who is Ron's rat?", options: ["Scabbers", "Wormtail", "Peter", "Trevor"], correctAnswer: 0 },
  { question: "Who is Neville's toad?", options: ["Trevor", "Algie", "Enid", "Bogrod"], correctAnswer: 0 },
  { question: "Who is Harry's owl?", options: ["Hedwig", "Errol", "Pigwidgeon", "Hermes"], correctAnswer: 0 },
  { question: "Who is Ron's owl?", options: ["Pigwidgeon", "Errol", "Hermes", "Hedwig"], correctAnswer: 0 },
  { question: "Who is the Weasley family owl?", options: ["Errol", "Pigwidgeon", "Hermes", "Hedwig"], correctAnswer: 0 },
  { question: "Who is Percy's owl?", options: ["Hermes", "Errol", "Pigwidgeon", "Hedwig"], correctAnswer: 0 },
  { question: "Who is Malfoy's owl?", options: ["Eagle Owl", "Barn Owl", "Snowy Owl", "Tawny Owl"], correctAnswer: 0 },
  { question: "Who is Ginny's Pygmy Puff?", options: ["Arnold", "Arthur", "Archie", "Albus"], correctAnswer: 0 },
  { question: "Who gave Harry the Marauder's Map?", options: ["Fred and George", "Lupin", "Sirius", "James"], correctAnswer: 0 },
  { question: "Who created the Marauder's Map?", options: ["Moony, Wormtail, Padfoot, and Prongs", "Fred and George", "The Founders", "Dumbledore"], correctAnswer: 0 },
  { question: "Who is Moony?", options: ["Remus Lupin", "Sirius Black", "James Potter", "Peter Pettigrew"], correctAnswer: 0 },
  { question: "Who is Wormtail?", options: ["Peter Pettigrew", "Remus Lupin", "Sirius Black", "James Potter"], correctAnswer: 0 },
  { question: "Who is Padfoot?", options: ["Sirius Black", "Remus Lupin", "James Potter", "Peter Pettigrew"], correctAnswer: 0 },
  { question: "Who is Prongs?", options: ["James Potter", "Remus Lupin", "Sirius Black", "Peter Pettigrew"], correctAnswer: 0 },
  { question: "What animal does James Potter transform into?", options: ["Stag", "Dog", "Rat", "Wolf"], correctAnswer: 0 },
  { question: "What animal does Sirius Black transform into?", options: ["Dog", "Stag", "Rat", "Wolf"], correctAnswer: 0 },
  { question: "What animal does Peter Pettigrew transform into?", options: ["Rat", "Dog", "Stag", "Wolf"], correctAnswer: 0 },
  { question: "What animal does Rita Skeeter transform into?", options: ["Beetle", "Fly", "Wasp", "Spider"], correctAnswer: 0 },
  { question: "What animal does Minerva McGonagall transform into?", options: ["Cat", "Owl", "Bird", "Mouse"], correctAnswer: 0 },
  { question: "What are the markings around McGonagall's eyes in cat form?", options: ["Spectacles", "Scars", "Lines", "Spots"], correctAnswer: 0 },
  { question: "What is the name of the poltergeist?", options: ["Peeves", "Bloody Baron", "Fat Friar", "Nick"], correctAnswer: 0 },
  { question: "Who is the only one who can control Peeves?", options: ["The Bloody Baron", "Dumbledore", "McGonagall", "Filch"], correctAnswer: 0 },
  { question: "What did Harry use to breathe underwater in the Second Task?", options: ["Gillyweed", "Bubble-Head Charm", "Transfiguration", "Diving Bell"], correctAnswer: 0 },
  { question: "What did Cedric use to breathe underwater?", options: ["Bubble-Head Charm", "Gillyweed", "Transfiguration", "Diving Bell"], correctAnswer: 0 },
  { question: "What did Krum use to breathe underwater?", options: ["Transfiguration (Shark)", "Bubble-Head Charm", "Gillyweed", "Diving Bell"], correctAnswer: 0 },
  { question: "What did Fleur use to breathe underwater?", options: ["Bubble-Head Charm", "Gillyweed", "Transfiguration", "Diving Bell"], correctAnswer: 0 },
  { question: "Who did Harry rescue in the Second Task?", options: ["Ron", "Hermione", "Cho", "Gabrielle"], correctAnswer: 0 },
  { question: "Who did Krum rescue in the Second Task?", options: ["Hermione", "Ron", "Cho", "Gabrielle"], correctAnswer: 0 },
  { question: "Who did Cedric rescue in the Second Task?", options: ["Cho", "Hermione", "Ron", "Gabrielle"], correctAnswer: 0 },
  { question: "Who did Fleur rescue in the Second Task?", options: ["No one (Failed)", "Gabrielle", "Ron", "Hermione"], correctAnswer: 0 },
  { question: "Who did Harry also rescue in the Second Task?", options: ["Gabrielle", "Fleur", "Cho", "Hermione"], correctAnswer: 0 },
  { question: "What song does the mermaid sing?", options: ["Only an hour long you'll have to look...", "Under the sea...", "Come seek us where our voices sound...", "In the deep blue sea..."], correctAnswer: 2 },
  ...
  { question: "Who succeeds Rufus Scrimgeour?", options: ["Pius Thicknesse", "Kingsley Shacklebolt", "Cornelius Fudge", "Arthur Weasley"], correctAnswer: 0 },
  { question: "Who succeeds Pius Thicknesse?", options: ["Kingsley Shacklebolt", "Arthur Weasley", "Harry Potter", "Hermione Granger"], correctAnswer: 0 },
  { question: "What is the name of the fountain in the Ministry atrium?", options: ["Fountain of Magical Brethren", "Fountain of Fair Fortune", "Fountain of Youth", "Fountain of Power"], correctAnswer: 0 },
  { question: "What department does Arthur Weasley work in (initially)?", options: ["Misuse of Muggle Artifacts", "Department of Mysteries", "Magical Games and Sports", "Magical Law Enforcement"], correctAnswer: 0 },
  { question: "What department is promoted to in Book 6?", options: ["Detection and Confiscation of Counterfeit Defensive Spells and Protective Objects", "Department of Mysteries", "Minister's Office", "Auror Office"], correctAnswer: 0 },
  { question: "Who works in the Department of Mysteries (that we know)?", options: ["Broderick Bode", "Arthur Weasley", "Percy Weasley", "Lucius Malfoy"], correctAnswer: 0 },
  { question: "What are the workers in the Department of Mysteries called?", options: ["Unspeakables", "Aurors", "Hit Wizards", "Obliviators"], correctAnswer: 0 },
  { question: "Who is the Head of the Auror Office (Book 5)?", options: ["Rufus Scrimgeour", "Kingsley Shacklebolt", "Nymphadora Tonks", "Alastor Moody"], correctAnswer: 0 },
  { question: "Who sent the Dementors to Little Whinging?", options: ["Dolores Umbridge", "Cornelius Fudge", "Voldemort", "Lucius Malfoy"], correctAnswer: 0 },
  { question: "What is the name of the group Hermione founds?", options: ["S.P.E.W.", "D.A.", "Slug Club", "Inquisitorial Squad"], correctAnswer: 0 },
  { question: "What is the name of the group Harry teaches?", options: ["Dumbledore's Army", "Harry's Heroes", "The Defense Group", "The Order"], correctAnswer: 0 },
  { question: "Where does the D.A. meet?", options: ["Room of Requirement", "Shrieking Shack", "Chamber of Secrets", "Forbidden Forest"], correctAnswer: 0 },
  { question: "How do D.A. members know the date of the meeting?", options: ["Fake Galleons", "Notes", "Owls", "Scars"], correctAnswer: 0 },
  { question: "Who betrayed the D.A.?", options: ["Marietta Edgecombe", "Cho Chang", "Zacharias Smith", "Seamus Finnigan"], correctAnswer: 0 },
  { question: "What appeared on the betrayer's face?", options: ["SNEAK", "TRAITOR", "LIAR", "SPY"], correctAnswer: 0 },
  { question: "Who hexed the piece of parchment the D.A. signed?", options: ["Hermione", "Harry", "Ron", "Ginny"], correctAnswer: 0 },
  { question: "What is the name of the sweet that makes you turn into a canary?", options: ["Canary Creams", "Ton-Tongue Toffee", "Skiving Snackbox", "Pygmy Puffs"], correctAnswer: 0 },
  { question: "Who is the ghost of Hufflepuff?", options: ["The Fat Friar", "The Bloody Baron", "Nearly Headless Nick", "The Grey Lady"], correctAnswer: 0 },
  { question: "Who is the ghost of Ravenclaw?", options: ["The Grey Lady", "The Bloody Baron", "The Fat Friar", "Nearly Headless Nick"], correctAnswer: 0 },
  { question: "Who is the ghost of Slytherin?", options: ["The Bloody Baron", "The Grey Lady", "The Fat Friar", "Nearly Headless Nick"], correctAnswer: 0 },
  { question: "Who is the ghost of Gryffindor?", options: ["Nearly Headless Nick", "The Bloody Baron", "The Fat Friar", "The Grey Lady"], correctAnswer: 0 },
  { question: "What is the name of the giant squid in the lake?", options: ["It doesn't have a name", "Kraken", "Leviathan", "Squidward"], correctAnswer: 0 },
  { question: "Who tickled the sleeping pear?", options: ["Hermione", "Harry", "Ron", "Fred"], correctAnswer: 0 },
  { question: "How do you get into the Hufflepuff common room?", options: ["Tap a barrel in the rhythm of 'Helga Hufflepuff'", "Say a password", "Answer a riddle", "Tickle a pear"], correctAnswer: 0 },
  { question: "What happens if you get the Hufflepuff knock wrong?", options: ["You get soaked in vinegar", "The door locks", "An alarm sounds", "You get trapped"], correctAnswer: 0 },
  { question: "How do you get into the Ravenclaw common room?", options: ["Answer a riddle", "Say a password", "Tap a barrel", "Tickle a pear"], correctAnswer: 0 },
  { question: "How do you get into the Slytherin common room?", options: ["Say a password", "Answer a riddle", "Tap a barrel", "Tickle a pear"], correctAnswer: 0 },
  { question: "How do you get into the Gryffindor common room?", options: ["Say a password", "Answer a riddle", "Tap a barrel", "Tickle a pear"], correctAnswer: 0 },
  { question: "Who replaces the Fat Lady in Book 3?", options: ["Sir Cadogan", "The Grey Lady", "Violet", "The Bloody Baron"], correctAnswer: 0 },
  { question: "Who is the Fat Lady's friend?", options: ["Violet", "The Grey Lady", "Helena", "Rowena"], correctAnswer: 0 },
  { question: "What painting guards the Gryffindor common room?", options: ["The Fat Lady", "Sir Cadogan", "The Grey Lady", "Barnabas the Barmy"], correctAnswer: 0 },
  { question: "What is the password to the Prefect's Bathroom?", options: ["Pine Fresh", "Caput Draconis", "Wattlebird", "Banana Fritters"], correctAnswer: 0 },
  { question: "What is the first password to Gryffindor Tower in Book 1?", options: ["Caput Draconis", "Pig Snout", "Wattlebird", "Fortuna Major"], correctAnswer: 0 },
  { question: "What is the password Harry uses to open the map?", options: ["I solemnly swear that I am up to no good", "Mischief Managed", "Open Sesame", "Alohomora"], correctAnswer: 0 },
  { question: "What is the password to close the map?", options: ["Mischief Managed", "I solemnly swear", "Close", "Nox"], correctAnswer: 0 },
  { question: "What did Harry do with the Elder Wand in the book?", options: ["Returned it to Dumbledore's tomb", "Snapped it in half", "Kept it", "Buried it"], correctAnswer: 0 },
  { question: "What did Harry do with the Elder Wand in the movie?", options: ["Snapped it in half", "Returned it to Dumbledore's tomb", "Kept it", "Buried it"], correctAnswer: 0 },
  { question: "Who played Dumbledore in the first two movies?", options: ["Richard Harris", "Michael Gambon", "Ian McKellen", "Christopher Lee"], correctAnswer: 0 },
  { question: "Who played Dumbledore in the later movies?", options: ["Michael Gambon", "Richard Harris", "Ian McKellen", "Christopher Lee"], correctAnswer: 0 },
  { question: "Who played Voldemort?", options: ["Ralph Fiennes", "Alan Rickman", "Gary Oldman", "Jason Isaacs"], correctAnswer: 0 },
  { question: "Who played Snape?", options: ["Alan Rickman", "Ralph Fiennes", "Gary Oldman", "Jason Isaacs"], correctAnswer: 0 },
  { question: "Who played Sirius Black?", options: ["Gary Oldman", "Alan Rickman", "Ralph Fiennes", "Jason Isaacs"], correctAnswer: 0 },
  { question: "Who played Bellatrix Lestrange?", options: ["Helena Bonham Carter", "Maggie Smith", "Emma Thompson", "Julie Walters"], correctAnswer: 0 },
  { question: "Who played McGonagall?", options: ["Maggie Smith", "Helena Bonham Carter", "Emma Thompson", "Julie Walters"], correctAnswer: 0 },
  { question: "Who played Trelawney?", options: ["Emma Thompson", "Maggie Smith", "Helena Bonham Carter", "Julie Walters"], correctAnswer: 0 },
  { question: "Who played Molly Weasley?", options: ["Julie Walters", "Maggie Smith", "Helena Bonham Carter", "Emma Thompson"], correctAnswer: 0 },
  { question: "Who played Lucius Malfoy?", options: ["Jason Isaacs", "Alan Rickman", "Gary Oldman", "Ralph Fiennes"], correctAnswer: 0 },
  { question: "What is the name of the act that forbids underage magic?", options: ["Decree for the Reasonable Restriction of Underage Sorcery", "Statute of Secrecy", "Wizengamot Charter", "Ministry Edict"], correctAnswer: 0 },
  { question: "What is the International Statute of Secrecy?", options: ["Law hiding magic from Muggles", "Law against Dark Arts", "Law for potion making", "Law for Quidditch"], correctAnswer: 0 },
  { question: "What is the Wizengamot?", options: ["Wizard High Court", "Wizard Parliament", "Wizard School", "Wizard Bank"], correctAnswer: 0 },
  { question: "Who presides over Harry's hearing in Book 5?", options: ["Cornelius Fudge", "Amelia Bones", "Dumbledore", "Percy Weasley"], correctAnswer: 0 },
  { question: "Who is Amelia Bones?", options: ["Head of Magical Law Enforcement", "Minister for Magic", "Undersecretary", "Auror"], correctAnswer: 0 },
  { question: "Who killed Amelia Bones?", options: ["Voldemort", "Bellatrix", "Greyback", "Lucius"], correctAnswer: 0 },
  { question: "Who is the Undersecretary to the Minister?", options: ["Dolores Umbridge", "Percy Weasley", "Amelia Bones", "Kingsley Shacklebolt"], correctAnswer: 0 },
  { question: "What color is Umbridge's cardigan?", options: ["Pink", "Green", "Blue", "Black"], correctAnswer: 0 },
  { question: "What kittens are on Umbridge's plates?", options: ["Frolicsome Felines", "Playful Paws", "Cute Cats", "Magic Meows"], correctAnswer: 0 },
  { question: "What blood status is Harry?", options: ["Half-blood", "Pure-blood", "Muggle-born", "Squib"], correctAnswer: 0 },
  { question: "What blood status is Hermione?", options: ["Muggle-born", "Half-blood", "Pure-blood", "Squib"], correctAnswer: 0 },
  { question: "What blood status is Ron?", options: ["Pure-blood", "Half-blood", "Muggle-born", "Squib"], correctAnswer: 0 },
  { question: "What blood status is Voldemort?", options: ["Half-blood", "Pure-blood", "Muggle-born", "Squib"], correctAnswer: 0 },
  { question: "What blood status is Snape?", options: ["Half-blood", "Pure-blood", "Muggle-born", "Squib"], correctAnswer: 0 },
  { question: "What blood status is Dumbledore?", options: ["Half-blood", "Pure-blood", "Muggle-born", "Squib"], correctAnswer: 0 },
  { question: "What blood status is McGonagall?", options: ["Half-blood", "Pure-blood", "Muggle-born", "Squib"], correctAnswer: 0 },
  { question: "What blood status is Lily Potter?", options: ["Muggle-born", "Half-blood", "Pure-blood", "Squib"], correctAnswer: 0 },
  { question: "What blood status is James Potter?", options: ["Pure-blood", "Half-blood", "Muggle-born", "Squib"], correctAnswer: 0 },
  { question: "What is a Squib?", options: ["Non-magical person born to wizards", "Wizard born to Muggles", "Magical creature", "Ghost"], correctAnswer: 0 },
  { question: "Who is a Squib?", options: ["Argus Filch", "Neville Longbottom", "Hermione Granger", "Dudley Dursley"], correctAnswer: 0 },
  { question: "Who else is a Squib?", options: ["Arabella Figg", "Petunia Dursley", "Vernon Dursley", "Marge Dursley"], correctAnswer: 0 },
  { question: "Who is Arabella Figg?", options: ["Harry's neighbor", "Harry's aunt", "Harry's teacher", "Harry's cousin"], correctAnswer: 0 },
  { question: "What does Mrs. Figg breed?", options: ["Kneazle-cat hybrids", "Owls", "Dogs", "Toads"], correctAnswer: 0 },
  { question: "What are the names of Mrs. Figg's cats?", options: ["Mr. Tibbles, Snowy, Mr. Paws, Tufty", "Tom, Dick, Harry", "Fluffy, Fang, Norbert", "Kitty, Cat, Puss"], correctAnswer: 0 },
  { question: "Who attacked Harry and Dudley in the alleyway?", options: ["Dementors", "Death Eaters", "Voldemort", "Werewolves"], correctAnswer: 0 },
  { question: "What did Dudley think Harry did to him?", options: ["Magic", "Hit him", "Cursed him", "Saved him"], correctAnswer: 0 },
  { question: "What is the name of the Dursleys' house?", options: ["Number 4 Privet Drive", "The Burrow", "Grimmauld Place", "Shell Cottage"], correctAnswer: 0 },
  { question: "What town is Privet Drive in?", options: ["Little Whinging", "Ottery St. Catchpole", "Godric's Hollow", "London"], correctAnswer: 0 },
  { question: "What school does Dudley attend?", options: ["Smeltings", "Stonewall High", "Hogwarts", "Eton"], correctAnswer: 0 },
  { question: "What school was Harry supposed to go to?", options: ["Stonewall High", "Smeltings", "Hogwarts", "Eton"], correctAnswer: 0 },
  { question: "What stick does Dudley carry?", options: ["Smeltings Stick", "Walking Stick", "Wand", "Bat"], correctAnswer: 0 },
  { question: "What color is the Smeltings uniform?", options: ["Maroon and Orange", "Blue and Silver", "Green and Black", "Red and Gold"], correctAnswer: 0 },
  { question: "What did Hagrid give Dudley?", options: ["A pig's tail", "A scar", "A hat", "A cake"], correctAnswer: 0 },
  { question: "Who removed Dudley's pig tail?", options: ["Private hospital in London", "Madam Pomfrey", "St Mungo's", "Vernon"], correctAnswer: 0 },
  { question: "What zoo did they go to?", options: ["London Zoo", "Bristol Zoo", "Chester Zoo", "Edinburgh Zoo"], correctAnswer: 0 },
  { question: "Who went to the zoo with them?", options: ["Piers Polkiss", "Dennis", "Gordon", "Malcolm"], correctAnswer: 0 },
  { question: "What happens to the glass in the snake enclosure?", options: ["It vanishes", "It breaks", "It turns to water", "It turns black"], correctAnswer: 0 },
];

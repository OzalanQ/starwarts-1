...
import { Sword, ShoppingBag, Backpack, User, BookOpen, FlaskConical } from 'lucide-react';
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`
                flex flex-col md:flex-row items-center md:px-4 md:py-4 rounded-lg transition-all duration-300 group relative overflow-hidden
                ${isActive 
